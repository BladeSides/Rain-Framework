...
{
    // Class for animating RectTransforms (for example, UI Objects) using a sin wave
    // Place the object in an empty transform where this script is attached
    // Written for RainFramework by BladeSides

    public class SinRectAnimator : MonoBehaviour
    {
        ...
        public void ResetTransformation()
        {
            ...
            RectTransform.localRotation = Quaternion.Euler(StartingRotation);
        ...
        private void SetStartingRotation()
        {
            StartingRotation = new Vector3
                (RectTransform.localRotation.eulerAngles.x,
                RectTransform.localRotation.eulerAngles.y,
                RectTransform.localRotation.eulerAngles.z) ;
        }
